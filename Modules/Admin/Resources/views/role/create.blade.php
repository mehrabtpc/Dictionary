        ...
        <div class="section">
            ...
            <div class="page-header rtl">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ثبت رول جدید</li>
                </ol>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Please Enter role Name" required>
                                </div>
                                <div class="form-group">
