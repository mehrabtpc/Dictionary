...
<head>
  ...
  <title>English | 404</title>
	...
	body{font-family:'Tahoma',Arial,sans-serif!important;font-weight:lighter;!important}
	@media only screen and (max-width:4000px){
	  .message{top:55%}
	  .message  h2{margin-top:10px}
	  .message  h1{margin-top:7vmin;font-size:27vmin;margin-bottom:-5vmin}
	  .owl-background{width:50%}
	  .moon{left:25%}
	  .moon .left{left:-40%}
	  .moon .right{right:-40%}
	  .owlmenu{display:block}
	  .branch{border-width:2vmin 0 2vmin 105vmin}
	}
	@media only screen and (max-width:795px){
	  .message  h2{margin-top:30px}
	  .moon .left{left:-40%}
	  .moon .right{right:-40%}
	  .owl-background{width:100%}
	  .branch{border-width:2vmin 0 2vmin 100vmin}
	}
	@media only screen and (max-width:480px){
	  .message  h2{margin-top:35px}
	  .owl-background{width:100%}
	  .moon .left{left:-40%}
	  .moon .right{right:-40%}
	  .owlmenu{display:none}
	  .branch{left:-59vmin}
	}
	.dusk{background-color:#010A24;overflow:hidden}
	.moon{position:absolute;height:52vmin;width:52vmin;border-radius:50%;background-color:#fff;box-shadow:0vmin 0vmin 25vmin 1vmin #fff;top:5%;transform:translateX(-50%);left:50%;z-index:15}
	.moon .left{position:absolute;color:#fff;font-family:arial;font-weight:600;margin-top:2w0px;z-index:5;font-size:35vmin;text-shadow:0vmin 1vmin 15vmin #fff}
	.moon .right{position:absolute;color:#fff;font-family:arial;font-weight:600;margin-top:20px;z-index:5;font-size:35vmin;text-shadow:0vmin 1vmin 15vmin #fff}
	.message{text-align:center}
	.message  h1{font-family:Tahoma;color:#FFCD66}
	.message  h2{color:#00D207;font-size:7.5vmin;font-weight:600;margin-bottom:0}
	.message  p{font-size:3vmin;color:#D20000;margin-top:5px;margin-bottom:1px}
	.owl-background{height:57vmin}
	.owl{position:absolute;top:4%;left:50%;transform:scale(0.75,0.75) translateX(-70%);-ms-transform:scale(0.75,0.75) translateX(-70%);-webkit-transform:scale(0.75,0.75) translateX(-70%);-o-transform:scale(0.75,0.75) translateX(-70%);-moz-transform:scale(0.75,0.75) translateX(-70%);z-index:16}
	.owl-body{width:30vmin;height:46vmin;background-color:#FFEAA8;-webkit-border-radius:0% 0% 35% 35%;border-radius:0% 0% 35% 35%}
	.owl-head{background-color:#FFEAA8;height:8vmin;width:100%}
	.ears{background-color:#fff;height:100%;border-radius:0% 0% 90% 90%}
	.nose{content:'';position:absolute;bottom:0;right:0;left:0;margin:auto;top:16vmin;width:0;height:0;z-index:1;border-style:solid;border-width:3vmin 2vmin 0 2vmin;border-color:#B87F0A transparent transparent transparent}
	.owl-eyes{height:30%;width:100%;position:relative;top:5%;display:-webkit-box;display:-moz-box;display:-webkit-flex;display:-ms-flexbox;display:box;display:flex;-webkit-box-align:center;-moz-box-align:center;-o-box-align:center;-ms-flex-align:center;-webkit-align-items:center;align-items:center;-webkit-box-pack:center;-moz-box-pack:center;-o-box-pack:center;-ms-flex-pack:center;-webkit-justify-content:center;justify-content:center}
	.feet{bottom:0;position:absolute;width:100%;z-index:10}
	.foot1{background:#B87F0A;height:5vmin;width:3vmin;border-radius:5vmin;display:inline-block;position:relative;left:6vmin;box-shadow:3vmin 0vmin 0vmin 0vmin #B87F0A}
	.foot2{background:#B87F0A;height:5vmin;width:3vmin;border-radius:5vmin;display:inline-block;position:relative;left:14vmin;box-shadow:3vmin 0vmin 0vmin 0vmin #B87F0A}
	.branch{z-index:5;position:absolute;top:91%;width:0;height:0;border-style:solid;border-color:transparent transparent transparent #693E05;transform:translateX(-50%);left:50%}
	.owleye{position:relative;overflow:hidden;text-align:center;width:2vmin;height:2vmin;border:3vmin solid #FFFCE8;padding:4.5vmin;border-radius:50%;box-sizing:border-box;margin:2em auto}
	.owleye.inner{position:absolute;background:#FFCD66;padding:0;width:auto;height:auto;border:none;margin:0;left:1%;right:1%;bottom:1%;top:1%}
	.owleye.inner-2{left:25%;right:25%;bottom:25%;top:26%;background:rgb(102,102,102);border:1px solid #FFCD66}
	.eyelid{position:absolute;height:50%;left:0;right:0;background:#ddd;transition:margin 0.15s ease}
	.eyelid.top{top:0;border-bottom:.6vmin solid #aaa;border-radius:200px 200px 0 0}
	.eyelid.bottom{bottom:0;border-radius:0 0 200px 200px;margin-bottom:-50%;-webkit-animation:blink 4s ease-in-out infinite;animation:blink 4s ease-in-out infinite}
	@keyframes blink{
	  0%{margin-bottom:-50%}
	  3%{margin-bottom:0%}
	  6%{margin-bottom:-50%}
	...
	@-webkit-keyframes sun{
	  0%{background-color:#FFFF66;-webkit-transform:translateY(0);transform:translateY(0);opacity:1}
	  70%{background-color:#FF4400}
	  100%{-webkit-transform:translateY(640px);transform:translateY(640px);opacity:0}
	}
	@keyframes sun{
	  0%{background-color:#FFFF66;-webkit-transform:translateY(0);transform:translateY(0);opacity:1}
	  70%{background-color:#FF4400}
	...
	@-webkit-keyframes clouds{
	  0%{-webkit-transform:translate(-250px,0);transform:translate(-250px,0)}
	  30%{opacity:1}
	  40%{opacity:0}
	  100%{-webkit-transform:translate(1000px,0);transform:translate(1000px,0);opacity:0}
	}
	@keyframes clouds{
	  0%{-webkit-transform:translate(-250px,0);transform:translate(-250px,0)}
	  30%{opacity:1}
	...
	@-webkit-keyframes ss{
	  0%{opacity:0;width:1px;height:1px;left:60%;top:20%}
	  50%{opacity:0.7;width:2px;height:4px;left:50%;top:25%}
	  75%{opacity:1;width:6px;height:10px;left:40%;top:30%}
	  85%{opacity:0.3}
	  100%{opacity:0;width:1px;height:1px;left:32%;top:36%}
	}
	@keyframes ss{
	  0%{opacity:0;width:1px;height:1px;left:60%;top:20%}
	  50%{opacity:0.7;width:2px;height:4px;left:50%;top:25%}
	...
	@-webkit-keyframes rayshift{
	  0%{border-color:#FFFF66}
	  100%{border-color:#FF4400}
	}
	@keyframes rayshift{
	  0%{border-color:#FFFF66}
	  100%{border-color:#FF4400}
...
<body class="dusk">
    ...
    <div class="col-md-12">
        <div class="message">
        <h2>404 Not Found</h2>
        <p>This page may have been deleted</p><br>
        <div class="btndiv"><a href="{{route('/')}}"><button class="btnpop">Back To Home</button></a></div>
        </div>
    </div>
    <div id='stars1'></div>
    <div id='stars2'></div>
